...
from shared_code.ttml2speech.TTMLtoVoiceConverter import TTMLtoVoiceConverter
...
def main(req: func.HttpRequest): # -> func.HttpResponse:
    ...
    logging.info(f'Instantiating the TTMLtoVoiceConverter object')
    my_converter = TTMLtoVoiceConverter(ttml_text = ttml, output_staging_directory=temp_path, prefix=video_id)
    ...
    logging.info('Parsing TTML to SSML')
    ...
    sentences_list = my_converter.pre_process_audio_snippets(
        ...
        avg_prosody_rate=round(prosody_rate, 1), 
